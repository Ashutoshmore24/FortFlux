...
export const getReportPopupHTML = (properties) => {
    ...
    return `
        <div style="font-family: system-ui, -apple-system, sans-serif; min-width: 220px; max-width: 260px;">
            ${imageUrl ? `
                <div style="width: 100%; height: 125px; border-radius: 8px; overflow: hidden; margin-bottom: 8px; background: #e2ece4; position: relative;">
            ...
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 4px;">
                <span style="font-size: 12px; font-weight: 700; color: #132a22;">${hazardTitle}</span>
            ...
            <div style="display: flex; justify-content: space-between; font-size: 9px; color: #64748b; border-top: 1px solid #e2ece4; padding-top: 4px;">
